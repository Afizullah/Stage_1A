                                                ...
                                                if($ecs = Formation::getEcs($fromUeId)){
                                                    foreach ($ecs as $ecKey => $ecFields) {
                                                        ...
                                                        if(!$newEcId = registreFields("ec",$dataEcFormated)){
                                                            $this->errors[]="Echec de l'importation des informations de l'ec ".$ecFields["ec_code"];
                                                        }
                                                    }
                                                }
                                            }else{
                                                $this->errors[]="Echec de l'importation des information de l'ue ".$ueFields["ue_code"];
                                            }
                                        }
                                    }
                                }else{
                                    $this->errors[]="Echec de l'importation des informations de ".$classeFields["classe_nom"];
                                }
                            }
                        }
                    }else{
                        $this->errors[]="Echec de l'importation de la formation ".$formationFields["formation_nom"];
                    }
                }
            }
        }
