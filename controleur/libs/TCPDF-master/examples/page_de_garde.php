<?php
function page_de_garde(TCPDF $pdf, $year, $cycle, $departement, $tel, $mail)
{
// set font
...
// nom de l'université
    ...
    $pdf->SetXY(135,41);
    $pdf->Cell(0, 0,$departement, 0, false, 'C', 0, '', 0, false, 'M', 'M');
// mention
...
// type de formation
    ...
    $pdf->SetXY(0, 155);
    $pdf->Cell(0, 0, $cycle, 0, false, 'R', 0, '', 0, false, 'M', 'M');
...
// coordonnées
    ...
    // set font
    $pdf->SetFont('dejavusansextralight', '', 14);
