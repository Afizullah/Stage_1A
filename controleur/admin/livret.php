            ...
            if($formationId = intval($formationsSelected[$i])){
                if(in_array($formationId,$formationsId)){
                    if($infosFormation = Formation::getInfosFormation($formationId)){
                        ...
                        $semestre=array(); $ue=array(); $nom=array(); $code=array();
                        $coef=array(); $cm=array(); $td=array(); $tp=array(); $tpe=array();
                        $obj=array(); $prerequis=array(); $contenu=array(); $eval=array(); $credits=array();
