...
define("ASSYNC_FILES",["regChange","livret","assync.SelectableFormations","assync.loadFile","assync.loadDb","assync_suggestion","assync.editProject","assync.loadSuggest","assync.loadOptions"]);
