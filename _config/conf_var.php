...
define("ASSYNC_FILES", ["regChange", "assync.SelectableFormations", "assync.loadFile", "assync.loadDb", "assync_suggestion", "assync.editProject", "assync.loadSuggest", "assync.loadOptions", "assync.changeSuggesStatus","assync_editUser","assync_livret"]);
define("MAP_PAGES", array(
    ...
    "showLivrets" => ["pageName" => "Liste des livrets"],
    "showSuggestion" => ["pageName" => "Liste des suggestions"],
