...
--
-- Hôte : localhost
-- Généré le :  mer. 27 juin 2018 à 12:36
...
--
ALTER TABLE `ec`
  MODIFY `ec_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `groupe`
  MODIFY `groupe_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
