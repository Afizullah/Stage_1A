...
<p>&nbsp;</p>
<h3 style="color: #2e6c80;"><span style="color: #000000;">Ce que vous pouvez faire en tant que <span
                style=""><span style="color: #ff0000;">responsable pédagogique </span>:</span></span>
</h3>
<p>&nbsp;</p>
...
<p>
    ...
    &nbsp; permet de consulter la liste des projets.</p>
<p>&nbsp;</p>
<p>
    ...
    &nbsp; permet de  consulter la liste des formations mais aussi d'importer/exporter une formation au format excel dans une nomenclature sp&eacute;cifique</p>
<p>&nbsp;</p>
<p>
    <span style="background-color: #2b2301; color: #fff; display: inline-block; padding: 3px 10px; font-weight: bold; border-radius: 5px;">Suggestions</span>&nbsp;
    permet de faire une suggestion concernant le contenu de la formation. Vous pouvez également consulter les suggestions émises.
</p>
<p>&nbsp;</p>
<p><strong>&nbsp;</strong></p>