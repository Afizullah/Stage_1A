    ...
    <ul>
        <li>
            ...
            <span class="layout-switcher">
                <input type="checkbox" id="switch_3" class="js-switch"  data-color="#76c880" data-secondary-color="#dedede" data-size="small"/>
            </span>
            ...
            <div class="radio mb-5">
                <input type="radio" name="radio-primary-color" id="pimary-color-pink" checked value="pimary-color-pink">
